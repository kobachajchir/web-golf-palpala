...
import type { FinancialMovementDocument } from '../../src/modules/accounting/domain/models.js';
...
function movement(id: string, patch: Partial<FinancialMovementDocument>) {
  const document: FinancialMovementDocument = {
    movementType: 'income',
