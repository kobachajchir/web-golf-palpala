...
function seedCharge(manager: InMemoryAccountingTransactionManager, id = 'fee-1') {
...
function seedLegacyMovement(manager: InMemoryAccountingTransactionManager, id = 'movement-1') {
