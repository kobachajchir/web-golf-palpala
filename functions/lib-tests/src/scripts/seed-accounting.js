...
import { DEFAULT_FINANCIAL_CONFIG, DEFAULT_FINANCIAL_EXPENSE_CATEGORIES, DEFAULT_FINANCIAL_INCOME_CATEGORIES, DEFAULT_PAYMENT_METHODS, PAYMENT_METHOD_IDS, SYSTEM_ACTOR_UID, } from '../modules/accounting/domain/constants.js';
