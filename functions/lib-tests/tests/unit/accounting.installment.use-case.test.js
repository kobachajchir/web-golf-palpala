...
import { createInstallmentPlanUseCase, listMyReceiptsUseCase, registerInstallmentPaymentUseCase, } from '../../src/modules/accounting/application/use-cases/installment.use-cases.js';
import { InMemoryAccountingTransactionManager, createAccountingActor, seedAccountingMember, seedCommissionRule, seedExpenseCategory, seedIncomeCategory, seedPaymentMethod, } from '../helpers/accounting-fakes.js';
...
test('una carga de ingreso reparte capital e interes y permite pagar cuotas con distintos medios', async () => {
    ...
    assert.equal(updatedRoot?.installmentPaidAmountMinor, firstPayment.scheduledAmountMinor + secondPayment.scheduledAmountMinor);
...
//# sourceMappingURL=accounting.installment.use-case.test.js.map