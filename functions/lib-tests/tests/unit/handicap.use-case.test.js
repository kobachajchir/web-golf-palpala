...
import { createActor, InMemoryUsersTransactionManager, seedHandicap, seedMember, seedUser, } from '../helpers/fakes.js';
test('recordHandicap garantiza un único handicap activo y actualiza el snapshot del socio', async () => {
    ...
    const activeHandicaps = Array.from(manager.handicaps.values()).filter((handicap) => handicap.memberId === 'member-1' && handicap.status === 'active');
...
//# sourceMappingURL=handicap.use-case.test.js.map